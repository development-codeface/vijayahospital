                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">hospitalhistory</span>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <?php
                                        ...
                                        if($this->id!=''){
                                           echo form_open_multipart(base_url()."admin/hospitalhistory/update/".$this->id, array("name" => "hospitalhistory", "id"=>"hospitalhistory","class" => "form-horizontal hospitalhistory","autocomplete"=>"off" )); 
                                        }else{
                                           echo form_open_multipart(base_url()."admin/hospitalhistory/add", array("name" => "hospitalhistory", "id"=>"hospitalhistory","class" => "form-horizontal hospitalhistory","autocomplete"=>"off" ));   
                                        }
                                   ?>
                                        <div class="form-body">
                                             <div id="img_msg"></div>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                   <input type="text" name="year" data-required="0" class="form-control"  value="<?=(isset($result['year'])&&$result['year']!='')?$result['year']:''?>"/> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"> <?php if(isset($result['image'])&& $result['image']!=''){?>
                                                           <img src="<?=base_url()?>uploads/hospitalhistory/<?=$result['image']?>">
                                                ...
                                                <?php }?>
                                                        ...
                                                        <div>
                                                            <span class="btn default btn-file">
                                                                ...
                                                                <input type="file" name="image" id="image" data-width="350" data-height="750" class="img_valid"> </span>
                                                    ...
                                                    <div class="clearfix margin-top-10">
                                                        <span class="required">
                                                           <?php 
                                                      echo "<h5 class='bold'>Image size should be 350*750</h5>";?>
                                                       </span><br>
                                                        </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                   <input type="hidden" id="id" name="id" value="<?=isset($result['id'])&&$result['id']!=''?$result['id']:''?>">
                                                    ...
                                                    <a type="button" class="btn default" href="<?=base_url()?>admin/hospitalhistory/index">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
