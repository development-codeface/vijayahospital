                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <?php
                                        ...
                                        if($this->id!=''){
                                           echo form_open_multipart(base_url()."admin/events/update/".$this->id, array("name" => "events", "id"=>"events","class" => "form-horizontal events","autocomplete"=>"off" )); 
                                        }else{
                                           echo form_open_multipart(base_url()."admin/events/add", array("name" => "events", "id"=>"events","class" => "form-horizontal events","autocomplete"=>"off" ));   
                                        }
                                   ?>
                                        <div class="form-body">
                                             <div id="img_msg"></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group  date-picker input-daterange" data-date="10/11/2012" data-date-format="dd-mm-yyyy">
                                                        <input type="text" class="form-control" name="date" value="<?=(isset($result['date'])&&$result['date']!='')?date('d-m-Y',strtotime($result['date'])):''?>"> </div>
                                                </div>
                                             </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"> <?php if(isset($result['image'])&& $result['image']!=''){?>
                                                           <img src="<?=base_url()?>uploads/events/<?=$result['image']?>">
                                                ...
                                                <?php }?>
                                                        ...
                                                        <div>
                                                            <span class="btn default btn-file">
                                                             ...
                                                             <!--    <input type="file" name="image" id="image" data-width="128" data-height="128" class="img_valid"> -->
                                                            </span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                   <input type="hidden" id="id" name="id" value="<?=isset($result['id'])&&$result['id']!=''?$result['id']:''?>">
                                                    ...
                                                    <a type="button" class="btn default" href="<?=base_url()?>admin/events/index">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
