<div class="portlet box green">
   <?php if($this->session->flashdata('error')){?>
                                ...
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Blog Listing
                                    </div>
                              <a href="<?=base_url()?>admin/blog/add" class="btn btn-danger pull-right">Add New</a> 
                                </div>
                                           ...
                                           <?php foreach($result as $res){ ?>
                                                <tr>
                                                   ...
                                                   <td> <?=date('d M Y',strtotime($res['created_at']))?> </td>
                                                    <td><button type="button" class="change_status_btn btn <?=($res['status'] == 'Active')?'btn-success':'btn-danger'?>" data-id="<?=$res['id']?>" data-module="blog"><?=$res['status']?></button> </td>
                                                   ...
                                                   <!--  <a type="button" class="btn  purple" href="<?=base_url()?>admin/Seo_management/manageseo/cms/<?=$res['id']?>">SEO </a> -->
                                                    <div class="btn-group ">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li>
                                                                        <a href="<?=base_url('admin/blog/update/'.$res['id'])?>"> Edit </a>
                                                                    </li>
                                                                    <li>
                                                                       <a  data-toggle="modal" class="delete_list_item"  data-id="<?=$res['id']?>" data-module="blog"> Delete </a>
                                                                    </li>
