                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <?php
                                        ...
                                        if($this->id!=''){
                                           echo form_open_multipart(base_url()."admin/gallery_category/update/".$this->id, array("name" => "gallery_category", "id"=>"gallery_category","class" => "form-horizontal gallery_category" )); 
                                        }else{
                                           echo form_open_multipart(base_url()."admin/gallery_category/add", array("name" => "gallery_category", "id"=>"gallery_category","class" => "form-horizontal gallery_category" ));   
                                        }
                                   ?>
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                   <input type="hidden" id="id" name="id" value="<?=isset($result['id'])&&$result['id']!=''?$result['id']:''?>">
                                                    ...
                                                    <a type="button" class="btn default" href="<?=base_url()?>admin/gallery_category">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
