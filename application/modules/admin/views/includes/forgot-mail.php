<title>Password Recovery</title>
    ...
    <div style="background-color: #d2d2d2;margin: 0px;padding: 30px 0;width: 100%;font-family: Montserrat, sans-serif;font-size: 14px;">
            ...
            <table style="margin: 0px auto;width: 100%;max-width: 600px;background-color: #e9e9e9; color: #000;padding: 80px 0;">
                    <tbody>
                            <tr>
                                    <td style="padding: 0px 40px 0;line-height: 24px;">Dear <?=SITE_NAME?>,</td>
                            </tr>
                            <tr>
                                    <td style="padding: 5px 40px 5px;line-height: 24px;font-size: 14px;">Your Password is <?=$result['password']?>.<br><br><?=SITE_NAME?> <br><?=$settings['siteAddress']?> <br><?=$settings['phoneNumber']?></td>
                            </tr>
