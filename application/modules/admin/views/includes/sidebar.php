<div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                      ...
                      <!--   <li>
                             <a href="<?=base_url()?>admin/flash_news" class="nav-link nav-toggle">
                                <i class="fa fa-bolt" style="color:white;"></i>
                                <span class="title">Flash News</span>
                               <?php if ($segment[2]=='flash_news') { ?>
                                     <span class="selected"></span>
                                      <?php } ?>
                                <span class="arrow <?=($segment[2]=='flash_news')?'open':'';?>"></span>
                            </a>
                        </li> 
                         <li class="nav-item  <?=(isset($segment[3])&&$segment[3]=='update_banner_logo')?'active open':'';?>">
                        ...
                        <li class="nav-item  <?=($segment[2]=='patient_care')?'active open':'';?>">
                            <a href="<?=base_url()?>admin/patient_care/index" class="nav-link nav-toggle">
                                <i class="fa fa-medkit" style="color: white"></i>
                                <span class="title">Patient Care</span>
                               <?php if ($segment[2]=='patient_care') { ?>
                                     <span class="selected"></span>
                                      <?php } ?>
                                <span class="arrow <?=($segment[2]=='patient_care')?'open':'';?>"></span>
                            </a>                          
                        </li>
                         <li class="nav-item  <?=($segment[2]=='facility')?'active open':'';?>">
                            <a href="<?=base_url()?>admin/facility/index" class="nav-link nav-toggle">
                                <i class="fa fa-wheelchair" style="color: white; font-weight: bold;"></i>
                      ...
                      <li class="nav-item  <?=($segment[2]=='hospitalhistory')?'active open':'';?>">
                            <a href="<?=base_url()?>admin/hospitalhistory/index" class="nav-link nav-toggle">
                                <i class="fa fa-history" style="color:white"></i>
                                <span class="title">Hospital's History <br>(About Page)</span>
                               <?php if ($segment[2]=='hospitalhistory') { ?>
                                     <span class="selected"></span>
                                      <?php } ?>
                                <span class="arrow <?=($segment[2]=='hospitalhistory')?'open':'';?>"></span>
                            </a>                          
                        </li>
                       
                      <li class="nav-item  <?=($segment[2]=='jobs')?'active open':'';?>">
                            <a href="<?=base_url()?>admin/jobs/index" class="nav-link nav-toggle">
                                <i class="fa fa-suitcase" style="color: white"></i>
                                <span class="title">Jobs</span>
                                 <?php if ($segment[2]=='jobs') { ?>
                                     <span class="selected"></span>
                                      <?php } ?>
                                <span class="arrow <?=($segment[2]=='jobs')?'open':'';?>"></span>
                            </a>
                    ...
                    <!--     <li class="nav-item  <?=($segment[2]=='gallery') && ($segment[3]=='partner')?'active open':'';?>">
                       ...
                       <li class="nav-item  <?=($segment[2]=='events')?'active open':'';?>">
                            <a href="<?=base_url()?>admin/events" class="nav-link nav-toggle">
                                <i class="fa fa-newspaper-o" style="color: white"></i>
                                <span class="title">News / Events</span>
                                <?php if ($segment[2]=='events') { ?>
                                     <span class="selected"></span>
                                      <?php } ?>
                                <span class="arrow <?=($segment[2]=='events')?'open':'';?>"></span>
                            </a>    
                        </li>
                        ...
                        <li class="nav-item  <?=($segment[2]=='cms')?'active open':'';?>">
                         ...
                         <!-- <li class="nav-item  <?=($segment[2]=='testimonial')?'active open':'';?>">
                            <a href="<?=base_url()?>admin/testimonial" class="nav-link nav-toggle">
                                <i class="fa fa-commenting" style="color: white"></i>
                        ...
                        <li class="nav-item  <?=($segment[2]=='newsletters')?'active open':'';?>">
                            <a href="<?=base_url()?>admin/newsletters" class="nav-link nav-toggle">
                                <i class="fa fa-paper-plane" style="color: white;font-weight: bold;"></i>
                                <span class="title">Newsletter</span>
                                <?php if ($segment[2]=='newsletters') { ?>
                                     <span class="selected"></span>
                                      <?php } ?>
                                <span class="arrow <?=($segment[2]=='newsletters')?'open':'';?>"></span>
                            </a>
