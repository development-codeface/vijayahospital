...
<?php $this->load->view('includes/header_asset'); ?>
        ...
        <div class="popup-wrapper">
            ...
            <div class="location-popup">
                ...
                <div class="row">
                    ...
                    <div id="google-map2">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15762.585061314372!2d76.7861345!3d9.0046595!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xcf60c7229a7b1540!2sVijaya%20Hospital%2C%20Kottarakkara!5e0!3m2!1sen!2sin!4v1601470079402!5m2!1sen!2sin" width="600" height="450" frameborder="0"   style="border:0" allowfullscreen></iframe>
            ...
            <div class="form-popupnew">
                ...
                <div class="row">
                    ...
                    <?php  $form = (($this->uri->segment(1) == 'career')?'career-form':'read_more'); ?>
        ...
        <div class="header-top-area grey-bg">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="width-16 margin-twenty-eight-left padding-5px-top cb"><i class="fa fa-ambulance padding-5px-right"></i>  24x7 Emergency Services

                    </div>

                    <div class="width-15 padding-5px-top cb"><i class="icon flaticon-phone-call padding-5px-right"> </i> <a href="tel:<?=$site_settings['phoneNumber']?>"><?=$site_settings['phoneNumber']?></a></div>

                    <div class="width-16 cb padding-5px-top margin-5px-left"><i class="far fa-envelope-open padding-5px-right"></i>  <a href="mailto:<?=$site_settings['siteEmail']?>" class=" "><?=$site_settings['siteEmail']?></a>
                    ...
                    <a href="#" id="open-form-popup"  class="width-17 cb req_apo"> 
                        ...
                        <div class=" text-center">
                            ...
                            <i class="fa fa-calendar padding-5px-rightj "></i>  Request an Appointment 
            ...
            <div class="header-area">          
                ...
                <div class="logo-area">
                    ...
                    <a href="<?=base_url('')?>">
                        ...
                        <img class="logo_new" src="<?=asset_path_web()?>/img/logo-2.png" alt="Nav Logo">
                            ...
                            <ul class="navbar-nav mega_menu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu width-400px">
                                       ...
                                       <!--<li><a href="<?=base_url('patient-care/4')?>">Patient stories</a></li>
                                        ...
                                        <li><a href="<?=base_url('patient-care/our-team')?>">Our Team</a></li>
                                ...
                                <li class="menu-item-has-children ">
                                    ...
                                    <a href="<?=base_url('department')?>">Department</a>
                                        ...
                                        <ul class="sub-menu width-1000px"> 
                                            ...
                                            foreach ($departments_menu as $key => $department) { ?>  
