...
class Web extends MY_Controller {
    ...
    public function index(){
        ...
        $data['depts'] = $this->Web_model->findAllWithJoin($conds,'departments','departments.*','','','','','','','','','');
     ...
     public function department_details($slug='')
    {
        ...
        $data['department_details'] = $this->Web_model->findAllWithJoin($conds,'departments','departments.*','','','','','','','','','');
        
        $department_id  = isset($data['department_details'][0]['id']) && $data['department_details'][0]['id']!=''?$data['department_details'][0]['id']:'';
        $data['doctors']='';
       ...
       //echo'<pre>'; print_r($data); die;
        echo $this->load->view('department_details',$data);
