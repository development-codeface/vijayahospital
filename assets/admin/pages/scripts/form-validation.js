...
var patient_care = function() {  

    var form3 = $('#patient_care');
    var error3 = $('.alert-danger', form3);
    var success3 = $('.alert-success', form3);
    var img_val  = $('.img_val').val();
    var imgs='';
...
var flash_news = function() {  

    var form3 = $('#flash_news');
    var error3 = $('.alert-danger', form3);
    var success3 = $('.alert-success', form3);
    var img_val  = $('.img_val').val();
    var imgs='';
...
var hospitalhistory = function() { 

        var form3 = $('#hospitalhistory');
        var error3 = $('.alert-danger', form3);
        var success3 = $('.alert-success', form3);
        var img_val  = $('.img_val').val();
        var imgs='';
