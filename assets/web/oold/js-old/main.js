...
$(document).on('click','#open-form-popup2',function(){
            $(".opening-popup, .location-popup").removeClass("popup-show ")
            $("#open-opening-popup, #open-location-popup").removeClass("active")
        
            $(".popup-wrapper, .form-popup2").animate().addClass("popup-show ");
            $("#open-form-popup").addClass("active")
        })      
         // Close popup
        $(document).on('click','.close-popup',function(){
            $(".popup-wrapper").removeClass("popup-show ")
            $("#open-opening-popup,#open-form-popup2, #open-location-popup, #open-form-popup").removeClass("active")
